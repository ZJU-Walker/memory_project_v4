...
# Project-relative so the copied memory_project works on any cluster.
DATA_ROOT = pathlib.Path(__file__).resolve().parents[3] / "data/0831_bin"
SUBTASKS = [  # 0830/0831 five-phase vocabulary (hotkeys 1..7); autogen labels come from
    # examples/yam/prepare_0830_memory_labels.py run on data/0831_episode_manifest_v1.json.
    "open both lids",
    "inspect both bins",
...
st.set_page_config(layout="wide", page_title="YAM 0831 Subtask Labeler")
